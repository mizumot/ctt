...
shinyUI(bootstrapPage(
    ...
    mainPanel(
        ...
        tabPanel("Main",
            ...
            h3("Cronbach's coefficient alpha and item-total correlation"),
            p('Carefully examine "r.drop" in "Item statistics" as part of item analysis. That index shows "corrected item-total correlation."'),
